...
{{--<script>--}}
{{--    const path = "{{ route('comments.query') }}";--}}
        ...
        <div class="col-12">
          <div class="card mb-4">
              <div class="card-header pb-0" style="display: flex; justify-content:space-between;">
                  ...
                  <a href="{{route('comments.create')}}" class="btn btn-primary active mb-0 text-white">
                      Create
                  </a>
              </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">User_Name</th>
                  ...
                  @foreach($comments as $comment)
                      <tr>
                          ...
                          <td style="text-align: center;">
                              ...
                              <a href="{{route('comments.edit', ['id'=>$comment->id])}}" class="btn btn-primary active mb-0 text-white" style="padding: 10px">
