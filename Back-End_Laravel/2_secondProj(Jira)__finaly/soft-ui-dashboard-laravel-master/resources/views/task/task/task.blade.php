            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="table-responsive p-0">
                  <div class="table_accordionComment1 bodyTaskTitle" style="padding: 0 15px;">
                      ...
                      <div class="pantry pantry_commentTask titleTableTask">
                          Comment
                      </div>
...
{{--                              <a class="btn btn-primary btn_comment" style="margin: 0" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">--}}
{{--                                  Comment--}}
{{--                              </a>--}}
                              <a class="btn btn-primary btn_comment" style="margin: 0" data-bs-toggle="collapse" href="#collapseComments{{$task->id}}" role="button" aria-expanded="false" aria-controls="collapseComments{{$task->id}}">
                                  Comment
                              </a>
                          </div>
                          <div class="pantry pantry_updateTask btn_update">
                                  <a href="{{route('tasks.edit', ['id'=>$task->id])}}" class="btn btn-primary btn_updatea active mb-0 text-white" style="padding: 10px">
                          ...
                          <div class="pantry pantry_deleteTask">
                              <form class="btn_destroy" action="{{route('tasks.destroy', ['id'=>$task->id])}}" method="post">
                                  @csrf
                                  @method('delete')
                      ...
                      <div class="collapse accordionactive" id="collapseComments{{$task->id}}">
