                        ...
                        <div class="card-body px-0 pt-0 pb-2 ">
                            <div class="table-responsive p-4">
                                <form action="{{route('projects.update',['id'=>$projects->id])}}" method="post">
                                    @csrf
                                    @method('put')
                                    <input type="text" class="form-control mb-3" name="name" id="name" value="{{$projects->name}}">
                                    <input type="text" class="form-control mb-3" name="description" id="description" value="{{$projects->description}}">
{{--                                    <input type="hidden" class="form-control mb-3" name="user_id" id="user_id" placeholder="id" value="1">--}}
