  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: auto">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        ...
        <li class="nav-item" style="border-bottom: 1px solid rgba(191,191,191,0.5)">
      ...
      <li class="nav-item" style="border-bottom: 1px solid rgba(191,191,191,0.5)">
            <a class="nav-link {{ (Request::is('taskUser') ? 'active' : '') }}" href="{{ url('taskUser') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>office</title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="nav-link-text ms-1">Task User (Assigners)
                </span>
            </a>
        </li>
      <li class="nav-item" style="border-bottom: 1px solid rgba(191,191,191,0.5)">
