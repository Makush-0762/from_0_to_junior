...
{{--                </form>--}}
                <form action="{{ route('role.update', ['id'=>$role->id]) }}" method="post" >
                    ...
                    <input type="radio" name="role" value="user" id="user" {{ $role->name == 'user' ? 'checked' : '' }}>
                    <label for="user">User</label>

                    <input type="radio" name="role" value="moderator" id="moderator" {{ $role->name == 'moderator' ? 'checked' : '' }}>
                    <label for="moderator">Moderator</label>

                    <input type="radio" name="role" value="admin" id="admin" {{ $role->name == 'admin' ? 'checked' : '' }}>
