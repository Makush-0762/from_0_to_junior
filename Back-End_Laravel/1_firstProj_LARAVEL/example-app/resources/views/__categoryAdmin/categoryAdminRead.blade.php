    ...
    <div class="container">
        <div class="row h-100">
            ...
            <div class="col-8 bg-white p-4 h-100" >
                ...
                <form action="{{route('__categoryAdmin.update', ['id'=>$categoryAdmin->id])}}" method="post">
                    @csrf
                    @method('put')
                    <input type="text" name="name" value="{{$categoryAdmin->name}}">
                    <input type="text" name="description" value="{{$categoryAdmin->description}}">
