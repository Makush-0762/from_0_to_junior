    ...
    <div class="container">
        <div class="row h-100">
            ...
            <div class="col-8 bg-white p-4 h-100" >
                ...
                <form action="{{route('table1.update', ['id'=>$table1->id])}}" method="post">
                    @csrf
                    @method('put')
                    <input type="text" name="name" placeholder="Name" value="{{$table1->name}}">
                    <input type="text" name="description" placeholder="Description" value="{{$table1->description}}">
                    <input type="text" name="price" placeholder="Price" value="{{$table1->price}}">
                    <input type="text" name="img" placeholder="Img" value="{{$table1->img}}">
