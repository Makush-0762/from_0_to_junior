        ...
        <div class="row h-100">
            ...
            <div class="col-8 bg-white p-4 h-100" >
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/__categoryAdmin') }}">Category</a>
                    </li>
                    <li class="nav-item">
                ...
                <a href="{{route('__categoryAdmin.create')}}"> Створити нову </a>
                    ...
                    <table class="table text-center">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td><a class="text-decoration-none fs-4" href="{{route('__categoryAdmin.edit', ['id'=>$category->id])}}">&#9881;</a></td>
                                <td>
                                    <form action="{{route('__categoryAdmin.destroy', ['id'=>$category->id])}}" method="post">
                                        @csrf
                                        @method('delete')
