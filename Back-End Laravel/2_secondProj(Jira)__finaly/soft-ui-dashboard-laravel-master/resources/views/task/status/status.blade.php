                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0" style="display: flex; justify-content:space-between;">
                            ...
                            <a href="{{route('status.create')}}" class="btn btn-primary active mb-0 text-white">
                                Create
                            </a>
                        </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Is Active</th>
